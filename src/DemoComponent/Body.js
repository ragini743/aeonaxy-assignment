    ...
    <div>
      ...
      {currentPage === 2 && (
        <UserData
          ...
          dataArray={arrayOfInterestedLearning}
          handleSelectOption={handleSelectOption}
          selectedOption={selectedOption}
        />
      )}
      ...
      <div className="justify-center flex">
        <button
          className={
            " text-white px-6 rounded-md py-2 " +
            (isContinue ? "bg-black" : "bg-gray-400")
          }
          onClick={isContinue ? handleContinue : undefined}
        >
          Continue
        </button>
      </div>
